...
if __name__ == "__main__":
    while True:
        ...
        if local not in [1,2,3,4,5,6,7,8]:
            ...
            while True:
                decidir = int(input("Digite 1 para cadastrar uma categoria\n"
                                    ...
                                    "Digite 5 para sair\n"))
                if decidir == 1 :
                    cat.cadastrarCatergoria(input('Qual o Nome da Nova Categoria ? :'))
                elif decidir == 2 :
                    cat.removerCategoria(input('Qual o nome da Categoria a Ser removida ? :'))
                elif decidir == 3:
                    categoria=input('Qual o nome da Categoria a ser alterada ? :')
                    novaCategoria=input('Qual o nome da nova categoria ?')
            ...
            while True:
                ...
                if decidir == 1:
                    ...
                    fornecedor = input("Digite o CNPJ do fornecedor que deseja remover: \n")
                    cat.removerFornecedor(fornecedor)
                elif decidir == 3:
                    novoNome = input("Digite o novo nome do fornecedor: \n")
                    cnpjAlterar = input('Digite o CNPJ do fornecedor que deseja alterar: \n')
                    ...
                    cat.alterarFornecedor(novoNome,cnpjAlterar,novoCnpj,novoTelefone,novoCategoria)
                elif decidir == 4:
            ...
            cat = Controllers.ControllerPessoa()
            while True:
                ...
                if decidir == 1:
                    ...
                    cat.cadastrarPessoa(nome, telefone, cpf, email, endereco)
                elif decidir == 2:
                    cliente = input("Digite o CPF do cliente que deseja remover: \n")

                    cat.removerPessoa(cliente)
                elif decidir == 3:
                    ...
                    cat.alterarPessoa(nomeAlterar, novoNome, novoTelefone, novoCpf, novoEmail, novoEndereco)
                elif decidir == 4:
                    cat.mostraPessoa()
                else:
                    break
            ...
            while True:
                ...
                if decidir == 1:
                    ...
                    funcionario = input("Digite o CPF do funcionario que deseja remover: \n")
                    cat.removerFuncionario(funcionario)
                elif decidir == 3:
                    cltAltera = input("Digite o CLT do funcionario que deseja alterar: \n")
                    ...
                    cat.alterarFuncionario(cltAltera,novoClt,novoNome,novoTelefone,novoCpf,novoEmail,novoEndereco)
            ...
            a = Controllers.ControllerVenda()
            a.relatorioProdutos()
        elif local == 8:
            break
        else:
            print('Erro ao selecionar opçao')
            break
